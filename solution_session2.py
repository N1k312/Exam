# -*- coding: utf-8 -*-
"""
Belle Croissant Lyonnais — ДЕМОЭКЗАМЕН (Session 2, проектирование)
==================================================================
Генерирует файлы-результаты для заданий 2.1 – 2.4:

  2.1  Session2_UseCaseDiagram.pdf       — диаграмма вариантов использования
  2.2  Session2_ERD.pdf                  — нормализованная ER-диаграмма (3NF)
  2.3  Session2_Wireframes_Staff.pdf     — каркасы экранов персонала
  2.4  Session2_CustomerAPI_Design.txt   — дизайн REST API для заказчиков

ВАЖНО: по условию экзамена Session 2 — это ПРОЕКТНАЯ работа (обычно в MS Visio).
Этот скрипт создаёт корректные по содержанию заготовки; просмотрите их и при
необходимости доработайте под себя.

Совместимо с macOS и Python 3.9. Зависимость только matplotlib.

ЗАПУСК:
    python3 solution_session2.py                 # результаты в ./output
    python3 solution_session2.py --output ./out  # своя папка
"""
...
# =============================================================================
# 2.3  WIREFRAMES (персонал, десктоп)  -> Session2_Wireframes_Staff.pdf
# =============================================================================
...
# =============================================================================
# 2.4  API DESIGN  -> Session2_CustomerAPI_Design.txt
# =============================================================================
API_DESIGN = """\
================================================================================
...
BASE URL
    https://api.bellecroissant.com/v1
